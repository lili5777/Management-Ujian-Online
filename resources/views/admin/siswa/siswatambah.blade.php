    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold text-gray-900">
                                    {{ isset($user) ? 'Edit Data Siswa' : 'Tambah Data Siswa' }}
                                </h1>
                                <p class="text-sm text-gray-600 mt-1">
                                    {{ isset($user) ? 'Perbarui informasi siswa' : 'Tambahkan data siswa baru' }}
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200/50">
                ...
                <div class="bg-gradient-to-r from-gray-900 to-gray-800 px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-white">Form Data Siswa</h3>
                ...
                <!-- Form Content -->
                <div class="p-6">
                    <form action="{{ route('possiswa') }}" method="POST" class="space-y-6">
                        @csrf
        ...
        <script>
            ...
            function adjustFormForMobile() {
                ...
                if (screenWidth < 640) {
                    ...
                    form.classList.remove('space-y-6');
                } else {
                    form.classList.remove('space-y-4');
