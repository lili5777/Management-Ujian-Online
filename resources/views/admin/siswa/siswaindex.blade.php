                    ...
                    <div>
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 mt-1">Kelola data siswa secara efisien</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <div class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl shadow-xl p-6 text-white">
                    ...
                    <h3 class="text-sm font-medium text-blue-100 mb-2">Jumlah Siswa</h3>
                ...
                <div class="bg-gradient-to-br from-green-600 to-green-700 rounded-2xl shadow-xl p-6 text-white">
                    ...
                    <h3 class="text-sm font-medium text-green-100 mb-2">Siswa Laki-laki</h3>
                ...
                <div class="bg-gradient-to-br from-pink-600 to-pink-700 rounded-2xl shadow-xl p-6 text-white">
                    ...
                    <h3 class="text-sm font-medium text-pink-100 mb-2">Siswa Perempuan</h3>
                ...
                {{-- <div class="bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl shadow-xl p-6 text-white">
                    ...
                    <h3 class="text-sm font-medium text-purple-100 mb-2">Rata-rata Nilai</h3>
                ...
                <div class="bg-gradient-to-r from-gray-900 to-gray-800 px-6 py-4">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-300">Total {{ $data->count() }} siswa terdaftar</p>
                        </div>
                        <div class="relative">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200" id="studentTable">
                                    ...
                                    @if (Auth::user()->level == 'admin')
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="flex items-center justify-center space-x-2">
                                                ...
                                                <form action="{{ route('hapussiswa', $d->id) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="{{ Auth::user()->level == 'admin' ? '7' : '6' }}"
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            <div class="text-sm text-gray-700">
                                Menampilkan <span class="font-semibold">{{ $data->count() }}</span> data siswa
                            </div>
        ...
        <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
            <div class="bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
                ...
                <p class="text-gray-600 mb-6">
                    Apakah Anda yakin ingin menghapus data siswa <span id="studentName" class="font-semibold"></span>?
