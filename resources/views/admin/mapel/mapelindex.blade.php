                    ...
                    <div>
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 mt-1">Kelola kurikulum dan mata pelajaran</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6 mb-8">
                <div class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl shadow-xl p-6 text-white">
                    ...
                    <h3 class="text-sm font-medium text-blue-100 mb-2">Mata Pelajaran</h3>
                ...
                {{-- <div class="bg-gradient-to-br from-green-600 to-green-700 rounded-2xl shadow-xl p-6 text-white">
                    ...
                    <h3 class="text-sm font-medium text-green-100 mb-2">Mapel Wajib</h3>
                    <p class="text-3xl font-bold">{{ $data->count() }}</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl shadow-xl p-6 text-white">
                    ...
                    <h3 class="text-sm font-medium text-purple-100 mb-2">Pengajar</h3>
                ...
                <div class="bg-gradient-to-br from-pink-600 to-pink-700 rounded-2xl shadow-xl p-6 text-white">
                    ...
                    <h3 class="text-sm font-medium text-pink-100 mb-2">Tersedia</h3>
                    <p class="text-3xl font-bold">-</p>
                </div> --}}
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200/50">
                ...
                <div class="bg-gradient-to-r from-gray-900 to-gray-800 px-6 py-4">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            <h3 class="text-lg font-bold text-white">Daftar Mata Pelajaran</h3>
                            <p class="text-sm text-gray-300">Total {{ $data->count() }} mata pelajaran terdaftar</p>
                        </div>
                        <div class="relative">
                            <input type="text" placeholder="Cari mata pelajaran..." id="searchInput"
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200" id="subjectTable">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <div class="flex-shrink-0">
                                                <div class="h-10 w-10 rounded-lg bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center">
                                                    <span class="text-white font-bold text-sm">{{ substr($d->kodemapel, 0, 2) }}</span>
                                                </div>
                                            </div>
                                            <div>
                                                <div class="text-sm font-medium text-gray-900 font-mono">{{ $d->kodemapel }}</div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="ml-2">
                                                <div class="text-sm font-medium text-gray-900">{{ $d->namamapel }}</div>
                                                <div class="flex items-center space-x-2 mt-1">
                                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                                        Wajib
                                                    </span>
                                                    <span class="text-xs text-gray-500">
                                                        {{ Str::limit($d->namamapel, 30) }}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @if (Auth::user()->level == 'admin')
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="flex items-center justify-center space-x-2">
                                                ...
                                                <form action="{{ route('hapusmapel', $d->id) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button"
                                                        onclick="confirmDelete('{{ $d->namamapel }}', this)"
                            ...
                            @empty
                                <tr>
                                    <td colspan="{{ Auth::user()->level == 'admin' ? '4' : '3' }}" class="px-6 py-12 text-center">
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            <div class="text-sm text-gray-700">
                                Menampilkan <span class="font-semibold">{{ $data->count() }}</span> mata pelajaran
                            </div>
