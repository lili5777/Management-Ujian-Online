    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold text-gray-900">
                                    {{ isset($user) ? 'Edit Data Mapel' : 'Tambah Data Mapel' }}
                                </h1>
                                <p class="text-sm text-gray-600 mt-1">
                                    {{ isset($user) ? 'Perbarui informasi mata pelajaran' : 'Tambahkan mata pelajaran baru' }}
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200/50 max-w-3xl mx-auto">
                ...
                <div class="bg-gradient-to-r from-gray-900 to-gray-800 px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-white">Form Mata Pelajaran</h3>
                                <p class="text-sm text-gray-300">Isi data mata pelajaran dengan benar</p>
                            </div>
                        </div>
                ...
                <!-- Form Content -->
                <div class="p-6">
                    <form action="{{ route('posmapel') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="kode" name="kode" required
                                    value="{{ old('kode', isset($user) ? $user->kodemapel : '') }}"
                                    ...
                                    placeholder="Contoh: MPL001" maxlength="10"
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                Gunakan format seperti: MPL001, MAT01, atau kode unik lainnya
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="nama" name="nama" required
                                    value="{{ old('nama', isset($user) ? $user->namamapel : '') }}"
                                    class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-300"
                        ...
                        <div class="bg-gradient-to-br from-amber-50 to-amber-100 border border-amber-200 rounded-xl p-4">
                            <h4 class="text-sm font-medium text-amber-800 mb-2 flex items-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="bg-white p-3 rounded-lg">
                                    <p class="text-xs text-gray-500 mb-1">Kode Mapel</p>
                                    <div class="flex items-center space-x-2">
                                        <div
                                            class="h-8 w-8 rounded-md bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center">
                                ...
                                <div class="bg-white p-3 rounded-lg">
                                    <p class="text-xs text-gray-500 mb-1">Nama Mapel</p>
