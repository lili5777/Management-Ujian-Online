                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div>
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                @if (isset($head) && $head)
                                    <h1 class="text-2xl font-bold text-gray-900">Data Siswa Kelas {{ $head->kodekelas }}</h1>
                                    <p class="text-sm text-gray-600 mt-1">{{ $head->namakelas }}</p>
                                @else
                                    <h1 class="text-2xl font-bold text-gray-900">Data Siswa Kelas</h1>
                                    <p class="text-sm text-gray-600 mt-1">Manajemen siswa per kelas</p>
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            @else
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl shadow-xl p-6 text-white">
                        ...
                        <h3 class="text-sm font-medium text-blue-100 mb-2">Siswa</h3>
                    ...
                    <div class="bg-gradient-to-br from-green-600 to-green-700 rounded-2xl shadow-xl p-6 text-white">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-xs font-semibold bg-white/30 px-3 py-1 rounded-full">Laki-laki</span>
                        </div>
                        <h3 class="text-sm font-medium text-green-100 mb-2">Siswa L</h3>
                        <p class="text-3xl font-bold">
                            @php
                                $maleCount = 0;
                                foreach ($data as $d) {
                                    $student = $siswa->where('id', $d->siswa)->first();
                                    if ($student && $student->jekel == 'l') {
                                        $maleCount++;
                                    }
                                }
                                echo $maleCount;
                    ...
                    <div class="bg-gradient-to-br from-pink-600 to-pink-700 rounded-2xl shadow-xl p-6 text-white">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-xs font-semibold bg-white/30 px-3 py-1 rounded-full">Perempuan</span>
                        </div>
                        <h3 class="text-sm font-medium text-pink-100 mb-2">Siswa P</h3>
                        <p class="text-3xl font-bold">
                            @php
                                $femaleCount = 0;
                                foreach ($data as $d) {
                                    $student = $siswa->where('id', $d->siswa)->first();
                                    if ($student && $student->jekel == 'p') {
                                        $femaleCount++;
                                    }
                                }
                                echo $femaleCount;
                ...
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200/50">
                    ...
                    <div class="bg-gradient-to-r from-gray-900 to-gray-800 px-6 py-4">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div>
                                <h3 class="text-lg font-bold text-white">Daftar Siswa Kelas {{ $head->kodekelas }}</h3>
                                <p class="text-sm text-gray-300">Total {{ $data->count() }} siswa dalam kelas</p>
                            </div>
                            <div class="flex items-center space-x-3">
                                <!-- Search -->
                                <div class="relative">
                    ...
                    @if ($data->isEmpty())
                        <div class="p-12 text-center">
                            <div class="text-gray-400">
                                ...
                                <h3 class="mt-4 text-lg font-medium text-gray-900">Belum ada siswa di kelas ini</h3>
                                <p class="mt-2 text-sm text-gray-500">Mulai dengan menambahkan siswa ke kelas {{ $head->namakelas }}.</p>
                                @if (Auth::user()->level == 'admin' || Auth::user()->level == 'guru')
                                    <div class="mt-6">
                                        <a href="{{ route('tambahsiswakelas', $kelas) }}"
                                    ...
                                    @foreach ($data as $index => $d)
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 h-10 w-10">
                                                        <div class="h-10 w-10 rounded-full bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center text-white font-bold">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                @elseif($student && $student->jekel == 'p')
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                                    <div class="flex items-center justify-center space-x-2">
                                                        ...
                                                        <form action="{{ route('hapussiswakelas', ['id' => $d->id, 'kelas' => $kelas]) }}"
                                                            ...
                                                            @method('DELETE')
                                                            <button type="button"
                                                                onclick="confirmDelete('{{ $student->name ?? 'Siswa' }}', this)"
                        ...
                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                                <div class="text-sm text-gray-700">
                                    Menampilkan <span class="font-semibold">{{ $data->count() }}</span> siswa di kelas {{ $head->namakelas }}
                                </div>
        ...
        <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
            <div class="bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
                ...
                <p class="text-gray-600 mb-6">
                    Apakah Anda yakin ingin menghapus <span id="studentName" class="font-semibold"></span> dari kelas ini?
